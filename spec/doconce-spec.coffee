describe "Doconce", ->
  ...
  it "tokenizes headings", ->
    {tokens} = grammar.tokenizeLine("========= Heading 9 =========")
    expect(tokens[0]).toEqual value: "=========", scopes: ["source.gfm", "markup.heading.heading-9.gfm", "markup.heading.marker.gfm"]
    expect(tokens[1]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-9.gfm", "markup.heading.space.gfm"]
    expect(tokens[2]).toEqual value: "Heading 9", scopes: ["source.gfm", "markup.heading.heading-9.gfm"]
    expect(tokens[3]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-9.gfm", "markup.heading.space.gfm"]
    expect(tokens[4]).toEqual value: "=========", scopes: ["source.gfm", "markup.heading.heading-9.gfm", "markup.heading.marker.gfm"]
    
    {tokens} = grammar.tokenizeLine("======= Heading 7 =======")
    expect(tokens[0]).toEqual value: "=======", scopes: ["source.gfm", "markup.heading.heading-7.gfm", "markup.heading.marker.gfm"]
    expect(tokens[1]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-7.gfm", "markup.heading.space.gfm"]
    expect(tokens[2]).toEqual value: "Heading 7", scopes: ["source.gfm", "markup.heading.heading-7.gfm"]
    expect(tokens[3]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-7.gfm", "markup.heading.space.gfm"]
    expect(tokens[4]).toEqual value: "=======", scopes: ["source.gfm", "markup.heading.heading-7.gfm", "markup.heading.marker.gfm"]
    ...
    expect(tokens[3]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-5.gfm", "markup.heading.space.gfm"]
    expect(tokens[4]).toEqual value: "=====", scopes: ["source.gfm", "markup.heading.heading-5.gfm", "markup.heading.marker.gfm"]
    ...
    expect(tokens[3]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.space.gfm"]
    expect(tokens[4]).toEqual value: "===", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.marker.gfm"]
    
    {tokens} = grammar.tokenizeLine("__ Heading 2 __")
    expect(tokens[0]).toEqual value: "__", scopes: ["source.gfm", "markup.heading.heading-2.gfm", "markup.heading.marker.gfm"]
    ...
    expect(tokens[3]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-2.gfm", "markup.heading.space.gfm"]
    expect(tokens[4]).toEqual value: "__", scopes: ["source.gfm", "markup.heading.heading-2.gfm", "markup.heading.marker.gfm"]

  it "tokenizes matches inside of headers", ->
    {tokens} = grammar.tokenizeLine("=== Heading :one: ===")
    expect(tokens[0]).toEqual value: "===", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.marker.gfm"]
    expect(tokens[1]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.space.gfm"]
    expect(tokens[2]).toEqual value: "Heading ", scopes: ["source.gfm", "markup.heading.heading-3.gfm"]
    expect(tokens[3]).toEqual value: ":", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "string.emoji.gfm", "string.emoji.start.gfm"]
    expect(tokens[4]).toEqual value: "one", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "string.emoji.gfm", "string.emoji.word.gfm"]
    expect(tokens[5]).toEqual value: ":", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "string.emoji.gfm", "string.emoji.end.gfm"]
  ...
  it "tokenizes tables", ->
    ...
    expect(headingTokens[0]).toEqual value: "===", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.marker.gfm"]
    expect(headingTokens[1]).toEqual value: " ", scopes: ["source.gfm", "markup.heading.heading-3.gfm", "markup.heading.space.gfm"]
    expect(headingTokens[2]).toEqual value: "Heading", scopes: ["source.gfm", "markup.heading.heading-3.gfm"]
